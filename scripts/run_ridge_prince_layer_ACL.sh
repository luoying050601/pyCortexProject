...
#>> "ridgeRegression_prince_${cur_date}".out 2>&1 & /home/ying/project/pyCortexProj/ridgeRegression/ridge_prince_layers.py
nohup /usr/bin/python3 -u /home/ying/project/pyCortexProj/xnli/ridge_prince_layers.py \
