...
nohup /usr/local/bin/python3.10 -u /home/ying/project/pyCortexProj/ridgeRegression/journal/ridge_gpt.py \
>> "/home/ying/project/pyCortexProj/ridgeRegression/journal/logs/ridgeRegression_prince_${cur_date}".out 2>&1 &