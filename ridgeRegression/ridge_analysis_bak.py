...
for model_type in model_list:
    ...
    if model_type == 'unsup-simcse-roberta-large':
        file_name = 'unsup-simcse-roberta-large_100000.0.pkl'
    if model_type == 'sup-simcse-roberta-large':
        file_name = 'sup-simcse-roberta-large_100000.0.pkl'

    clf = joblib.load(f'models/'+file_name)
    ...
    # brain_score: -0.00014208055635837546
